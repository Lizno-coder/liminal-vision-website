...
export default function AutomobilPage() {
  return (
    <div className="min-h-screen text-white overflow-x-hidden">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              ...
              <Link href="/kontakt?websiteType=automotive" className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#6366f1] to-[#818cf8] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-[#6366f1]/25 hover:shadow-[#6366f1]/40 transition-all hover:scale-[1.02]">
      ...
      <IndustrySeoLinks currentSlug="automobil-service" accentColor="#6366f1" />
