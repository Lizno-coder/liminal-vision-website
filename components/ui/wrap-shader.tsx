...
export default function WarpShader({ className, blurClassName }: WarpShaderProps) {
  return (
    <div className={cn("absolute inset-0 overflow-hidden", className)} aria-hidden="true">
      ...
      <div className="absolute inset-0 sm:hidden bg-[radial-gradient(circle_at_15%_20%,rgba(41,151,255,0.18),transparent_28%),radial-gradient(circle_at_85%_22%,rgba(88,86,214,0.16),transparent_32%),radial-gradient(circle_at_58%_78%,rgba(23,210,194,0.12),transparent_28%),linear-gradient(135deg,rgba(6,12,26,0.97),rgba(7,18,38,0.94))] animate-flow-gradient" />
      <div className="absolute inset-0 bg-[#02050d]/78 sm:bg-[#02050d]/74" />
