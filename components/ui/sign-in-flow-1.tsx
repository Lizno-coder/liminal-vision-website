...
export function CanvasRevealEffect({
  animationSpeed = 8,
  opacities = [0.16, 0.2, 0.24, 0.34, 0.42, 0.5, 0.62, 0.72, 0.86, 1],
  colors = [
    [41, 151, 255],
    [88, 86, 214],
  ],
  ...
  return (
    <div className={cn("relative h-full w-full", containerClassName)}>
      ...
      />
      {showGradient ? (
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(10,10,10,0.55)_45%,rgba(10,10,10,0.98)_100%)]" />
      ) : null}
    </div>
  );
}
...
function DotMatrix({
  colors = [[41, 151, 255]],
  opacities = [0.04, 0.04, 0.08, 0.08, 0.14, 0.18, 0.24, 0.32, 0.48, 0.6],
  totalSize = 20,
  dotSize = 3,
  shader = "",
  center = ["x", "y"],
