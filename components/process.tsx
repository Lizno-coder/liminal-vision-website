...
import { FlowGradientCard } from "@/components/ui/flow-gradient";
        ...
        <div className="relative">
          ...
          <div className="grid gap-6 md:grid-cols-4">
            {steps.map((step, i) => (
              ...
              >
                <FlowGradientCard className="p-6">
                  <motion.div
                    whileHover={{ scale: 1.1, rotate: 360 }}
                    transition={{ duration: 0.5 }}
                    className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#2997ff]/30 to-[#5856d6]/30 backdrop-blur-sm"
                  >
