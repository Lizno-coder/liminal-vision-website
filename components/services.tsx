...
function MiniSiteFrame({
  ...
  return (
    <motion.div
      whileHover={{ y: -8, rotateX: 1.5, rotateY: -1.5, scale: 1.01 }}
      transition={{ type: "spring", stiffness: 180, damping: 18, mass: 0.8 }}
      className={`group relative h-[420px] overflow-hidden rounded-[2rem] border border-white/10 bg-[#0d0d0f]/95 shadow-[0_30px_100px_rgba(0,0,0,0.35)] ${className}`}
...
function CafeMiniSite() {
  return (
    <MiniSiteFrame className="bg-[#20150f]">
      <div className="min-h-[760px] bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.18),transparent_28%),linear-gradient(180deg,#2a1b13_0%,#1b120e_100%)] px-5 pb-6 pt-5 text-[#fff7ed]">
...
function FitnessMiniSite() {
  return (
    <MiniSiteFrame className="bg-[#08100c]">
      <div className="min-h-[780px] bg-[radial-gradient(circle_at_80%_0%,rgba(34,197,94,0.18),transparent_25%),linear-gradient(180deg,#07110c_0%,#0b1612_55%,#08100c_100%)] px-5 pb-6 pt-5 text-white">
...
function HandwerkMiniSite() {
  return (
    <MiniSiteFrame className="bg-[#14111c]">
      <div className="min-h-[760px] bg-[radial-gradient(circle_at_top_left,rgba(167,139,250,0.16),transparent_28%),linear-gradient(180deg,#13111b_0%,#161320_100%)] px-5 pb-6 pt-5 text-white">
...
function BeautyMiniSite() {
  return (
    <MiniSiteFrame className="bg-[#1c1017]">
      <div className="min-h-[790px] bg-[radial-gradient(circle_at_80%_0%,rgba(251,113,133,0.16),transparent_28%),linear-gradient(180deg,#1b1117_0%,#1c1017_100%)] px-5 pb-6 pt-5 text-white">
...
const miniSites = [
  {
    ...
    text: "Warm, einladend und auf Reservierungen optimiert.",
    component: <CafeMiniSite />,
  },
  {
    title: "Fitness & Studios",
    text: "Klar, energiegeladen und conversion-stark.",
    component: <FitnessMiniSite />,
  },
  {
    title: "Handwerk",
    text: "Ruhig, präzise und vertrauenswürdig aufgebaut.",
    component: <HandwerkMiniSite />,
  },
  {
    title: "Beauty & Kosmetik",
    text: "Elegant, weich und hochwertig inszeniert.",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <h2 className="text-3xl font-semibold tracking-[-0.03em] text-white md:text-4xl">
            Kompakte Mini-Websites statt generischer Blöcke.
          </h2>
          <p className="mt-4 max-w-xl text-sm leading-6 text-white/55 sm:text-base">
            Jede Vorschau ist wie eine kleine echte Startseite aufgebaut: scrollbar,
            eigenständig im Stil und passend zur jeweiligen Branche.
          </p>
        </motion.div>

        <div className="grid gap-8 lg:grid-cols-2">
          {miniSites.map((site, index) => (
            <motion.div
              key={site.title}
            ...
            >
              <div className="mb-4 flex items-end justify-between gap-4">
                <div>
                  <h3 className="text-lg font-medium text-white">{site.title}</h3>
                  <p className="mt-1 text-sm text-white/50">{site.text}</p>
                </div>
              </div>
              {site.component}
            </motion.div>
